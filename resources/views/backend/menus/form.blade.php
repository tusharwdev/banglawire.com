...
@section('content')
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div> {{ isset($menu) ? 'Edit' : 'Create' }} | Menu
    ...
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{ isset($menu) ? route('secure.menus.update',$menu->id) : route('secure.menus.store') }}" enctype="multipart/form-data">
                @csrf
                @isset($menu)
                    @method('PUT')
                @endisset
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" class="form-control @error('name') is-invalid @enderror " name="name"
                                       value="{{ $menu->name ?? old('name')}}"  autofocus
                                       required
                                >
                                @error('name')
