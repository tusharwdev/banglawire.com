...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form method="post" action="{{ route('secure.settings.appearance.update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="main-card mb-3 card" style="padding: 10px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="site_logo" data-default-file="{{ setting('site_logo') != null ? asset('storage/'.setting('site_logo')) : '' }}"
                        ...
                        <div class="form-group">
                            <label for="favicon">Favicon (Only Image are Allowed | Size : 33 * 33 (px)</label>
                            <input type="file" id="favicon" data-default-file="{{ setting('favicon') != null ? asset('storage/'.setting('favicon')) : '' }}"
